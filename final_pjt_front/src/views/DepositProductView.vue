...
export default {
  components: { DepositProductDetail },
  setup() {
    ...
    onMounted(async () => {
      await depositStore.getDepositProductsWithHighestRate();
      bankOptions.value = [
        ...new Set(depositStore.depositProductsData.map((p) => p.kor_co_nm)),
      ];
    });

    const filteredProducts = computed(() => {
      let products = depositStore.depositProductsData;
